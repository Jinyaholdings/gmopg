...
(0, ava_1.default)('exports PayType as enum', (t) => {
    const expect = {
        Cash: 'Z',
        Credit: '0',
        Suica: '1',
...
(0, ava_1.default)('exports Method as enum', (t) => {
    const expect = {
        Lump: '1',
        Installment: '2',
        BonusLump: '3',
...
(0, ava_1.default)('exports Status as enum', (t) => {
    const expect = {
...
(0, ava_1.default)('exports JobCd as enum', (t) => {
    const expect = {
        Check: 'CHECK',
        Capture: 'CAPTURE',
        Auth: 'AUTH',
...
(0, ava_1.default)('exports SeqMode as enum', (t) => {
    const expect = {
        Logic: '0',
        Physics: '1'
    };
...
(0, ava_1.default)('exports DefaultFlag as enum', (t) => {
    const expect = {
        BillingObject: '0',
...
(0, ava_1.default)('exports CvsCode as enum', (t) => {
    const expect = {
        _Lawson: '00001',
        _FamilyMart: '00002',
        _Sunkus: '00003',
